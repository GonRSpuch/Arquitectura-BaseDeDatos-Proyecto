...
*Figura 1: Pestaña Viajes*

![Pestaña Servicios y Pagos](PestañaPasajeros.png)

*Figura 2: Pestaña Pasajeros.*

![Pestaña Dashboard y KPIs](PestañaServiciosyPagos.png)
*Figura 3: Pestaña Servicios y Pagos*

### Control Dinámico y Alerta de Vencimientos

Ahora también, para evitar demoras en los pagos a proveedores, prevenir recargos por mora y garantizar la continuidad operativa de los viajes, se incorporó la columna **`Alerta de Pago`** dentro de la estructura de *Servicios y Pagos*.
